            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="mb-3">
                            <label class="control-label mb-1">Sub Titile</label>
                            <input type="text" name="sub_title"
                                class="form-control @error('sub_title') is-invalid @enderror" placeholder="..."
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-body p-0">
                                                ...
                                                <img src="{{ asset('uploads/main-slider/' . $data->image) }}"
                                                    alt="image" width="100%">
                                            </div>
                                        </div>
                                    </div>
