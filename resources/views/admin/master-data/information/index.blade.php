                    ...
                    <tbody>
                        @foreach ($datas as $result)
                            <tr>
                                ...
                                <td>{{ $result->title ?? '' }}</td>
                                <td>
                                    <a href="{{ $result->link_image ?? '' }}" class="btn btn-sm btn-info" target="_blank">
                                        <i class="ti ti-link"></i>
                                    </a>
                                </td>
                                <td>
                                    <a href="{{ $result->link_information ?? '' }}" class="btn btn-sm btn-info" target="_blank">
                                        <i class="ti ti-link"></i>
                                    </a>
                                </td>
                                <td>
        ...
        <div class="card-body">
            <div class="alert alert-warning mb-0" role="alert">
                <div class="d-flex gap-2 align-items-center">
                    ...
                    <p class="mb-0">
                        No information data yet. <a href="{{ route('admin.'. $active . '.create') }}">Add</a> now.
                    </p>
                </div>
            </div>
        </div>
